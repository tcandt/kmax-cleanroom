...
public final class AudioEncoder implements AsyncProcessor {
    ...
    public void start(final AsyncProcessor.TerminationListener terminationListener) {
        Thread thread = new Thread(new Runnable() { // from class: com.android.helper.audio.AudioEncoder$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$start$0$com-android-helper-audio-AudioEncoder(terminationListener);
            }
        }, "audio-encoder");
        this.thread = thread;
        thread.start();
    ...
    /* synthetic */ void lambda$start$0$com-android-helper-audio-AudioEncoder(AsyncProcessor.TerminationListener terminationListener) {
        boolean z = true;
        z = false;
        try {
            encode();
    ...
    private void encode() throws Throwable {
        final MediaCodec mediaCodecCreateMediaCodec;
        ...
        try {
            ...
            mediaCodecCreateMediaCodec = createMediaCodec(codec, this.encoderName);
            try {
                String canonicalName = mediaCodecCreateMediaCodec.getCanonicalName();
                this.recreatePts = "c2.android.opus.encoder".equals(canonicalName) || "c2.android.flac.encoder".equals(canonicalName);
                HandlerThread handlerThread3 = new HandlerThread("media-codec");
                this.mediaCodecThread = handlerThread3;
                handlerThread3.start();
                MediaFormat mediaFormatCreateFormat = createFormat(codec.getMimeType(), this.bitRate, this.codecOptions);
                mediaCodecCreateMediaCodec.setCallback(new EncoderCallback(), new Handler(this.mediaCodecThread.getLooper()));
                mediaCodecCreateMediaCodec.configure(mediaFormatCreateFormat, (Surface) null, (MediaCrypto) null, 1);
                this.capture.start();
                this.inputThread = new Thread(new Runnable() { // from class: com.android.helper.audio.AudioEncoder$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$encode$1$com-android-helper-audio-AudioEncoder(mediaCodecCreateMediaCodec);
                    }
                }, "audio-in");
                this.outputThread = new Thread(new Runnable() { // from class: com.android.helper.audio.AudioEncoder$$ExternalSyntheticLambda4
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$encode$2$com-android-helper-audio-AudioEncoder(mediaCodecCreateMediaCodec);
                    }
                }, "audio-out");
                ...
                try {
                    ...
                    waitEnded();
                    HandlerThread handlerThread4 = this.mediaCodecThread;
                    if (handlerThread4 != null && (looper2 = handlerThread4.getLooper()) != null) {
                        looper2.quitSafely();
                    }
                    Thread thread5 = this.inputThread;
                    if (thread5 != null) {
                        thread5.interrupt();
                    }
                    Thread thread6 = this.outputThread;
                    if (thread6 != null) {
                        thread6.interrupt();
                    }
                    try {
                        HandlerThread handlerThread5 = this.mediaCodecThread;
                        if (handlerThread5 != null) {
                            handlerThread5.join();
                        }
                        Thread thread7 = this.inputThread;
                        if (thread7 != null) {
                            thread7.join();
                        }
                        Thread thread8 = this.outputThread;
                        if (thread8 != null) {
                            thread8.join();
                        }
                        if (mediaCodecCreateMediaCodec != null) {
                            mediaCodecCreateMediaCodec.stop();
                            mediaCodecCreateMediaCodec.release();
                        }
                        AudioCapture audioCapture2 = this.capture;
                    ...
                    try {
                        ...
                        th = th;
                        z = z2;
                        handlerThread = this.mediaCodecThread;
                        if (handlerThread != null && (looper = handlerThread.getLooper()) != null) {
                            looper.quitSafely();
                        }
                        thread = this.inputThread;
                        if (thread != null) {
                            thread.interrupt();
                        }
                        thread2 = this.outputThread;
                        if (thread2 != null) {
                            thread2.interrupt();
                        }
                        try {
                            handlerThread2 = this.mediaCodecThread;
                            if (handlerThread2 != null) {
                                handlerThread2.join();
                            }
                            thread3 = this.inputThread;
                            if (thread3 != null) {
                                thread3.join();
                            }
                            thread4 = this.outputThread;
                            if (thread4 != null) {
                                thread4.join();
                            }
                            if (mediaCodecCreateMediaCodec != null) {
            ...
            mediaCodecCreateMediaCodec = null;
            e = e6;
        } catch (Throwable th5) {
            th = th5;
            mediaCodecCreateMediaCodec = null;
    ...
    /* synthetic */ void lambda$encode$1$com-android-helper-audio-AudioEncoder(MediaCodec mediaCodec) {
        try {
            try {
    ...
    /* synthetic */ void lambda$encode$2$com-android-helper-audio-AudioEncoder(MediaCodec mediaCodec) {
        try {

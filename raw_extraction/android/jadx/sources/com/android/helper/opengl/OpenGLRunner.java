...
public final class OpenGLRunner {
    ...
    public void run(Size size, final Size size2, Surface surface) throws OpenGLException {
        ...
        this.filter.init();
        this.surfaceTexture.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: com.android.helper.opengl.OpenGLRunner$$ExternalSyntheticLambda1
            @Override // android.graphics.SurfaceTexture.OnFrameAvailableListener
            public final void onFrameAvailable(SurfaceTexture surfaceTexture2) {
                this.f$0.lambda$run$0$com-android-helper-opengl-OpenGLRunner(size2, surfaceTexture2);
            }
        }, handler);
    }

    /* synthetic */ void lambda$run$0$com-android-helper-opengl-OpenGLRunner(Size size, SurfaceTexture surfaceTexture) {
        if (this.stopped) {
            return;
        }
        render(size);
    ...
    public void stopAndRelease() {
        ...
        handler.post(new Runnable() { // from class: com.android.helper.opengl.OpenGLRunner$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$stopAndRelease$1$com-android-helper-opengl-OpenGLRunner(semaphore);
            }
        });
        try {
            semaphore.acquire();
    ...
    /* synthetic */ void lambda$stopAndRelease$1$com-android-helper-opengl-OpenGLRunner(Semaphore semaphore) {
        this.stopped = true;

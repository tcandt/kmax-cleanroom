...
public class CodecOption {
    ...
    private static CodecOption parseOption(String str) {
        ...
        Object objSubstring = str.substring(iIndexOf + 1);
        strSubstring2.hashCode();
        switch (strSubstring2) {
            case "string":
                break;
            case "int":
                objSubstring = Integer.valueOf(Integer.parseInt(objSubstring));
                break;
            case "long":
                objSubstring = Long.valueOf(Long.parseLong(objSubstring));
                break;
            case "float":
                objSubstring = Float.valueOf(Float.parseFloat(objSubstring));
                break;
            default:

...
public final class UhidManager {
    ...
    private void registerUhidListener(final int i, FileDescriptor fileDescriptor) {
        if (Build.VERSION.SDK_INT >= 23) {
            this.queue.addOnFileDescriptorEventListener(fileDescriptor, 1, new MessageQueue.OnFileDescriptorEventListener() { // from class: com.android.helper.control.UhidManager$$ExternalSyntheticLambda3
                @Override // android.os.MessageQueue.OnFileDescriptorEventListener
                public final int onFileDescriptorEvents(FileDescriptor fileDescriptor2, int i2) {
                    return this.f$0.lambda$registerUhidListener$0$com-android-helper-control-UhidManager(i, fileDescriptor2, i2);
                }
            });
        }
    }

    /* synthetic */ int lambda$registerUhidListener$0$com-android-helper-control-UhidManager(int i, FileDescriptor fileDescriptor, int i2) {

...
public class SurfaceEncoder implements AsyncProcessor {
    ...
    public void start(final AsyncProcessor.TerminationListener terminationListener) {
        Thread thread = new Thread(new Runnable() { // from class: com.android.helper.video.SurfaceEncoder$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$start$0$com-android-helper-video-SurfaceEncoder(terminationListener);
            }
        }, "video");
        this.thread = thread;
        thread.start();
    ...
    /* synthetic */ void lambda$start$0$com-android-helper-video-SurfaceEncoder(AsyncProcessor.TerminationListener terminationListener) {
        Looper.prepare();
        try {
            streamCapture();
        } catch (IOException e) {

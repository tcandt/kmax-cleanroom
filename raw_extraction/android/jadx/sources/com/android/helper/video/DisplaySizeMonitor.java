...
public class DisplaySizeMonitor {
    ...
    public void start(final int i, Listener listener) {
        ...
        if (USE_DEFAULT_METHOD) {
            ...
            handlerThread.start();
            this.displayListenerHandle = ServiceManager.getDisplayManager().registerDisplayListener(new DisplayManager.DisplayListener() { // from class: com.android.helper.video.DisplaySizeMonitor$$ExternalSyntheticLambda0
                @Override // com.android.helper.wrappers.DisplayManager.DisplayListener
                public final void onDisplayChanged(int i2) {
                    this.f$0.lambda$start$0$com-android-helper-video-DisplaySizeMonitor(i, i2);
                }
    ...
    /* synthetic */ void lambda$start$0$com-android-helper-video-DisplaySizeMonitor(int i, int i2) {
        if (Ln.isEnabled(Ln.Level.VERBOSE)) {

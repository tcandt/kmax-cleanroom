...
public final class CleanUp {
    ...
    private CleanUp(final Options options) {
        Thread thread = new Thread(new Runnable() { // from class: com.android.helper.CleanUp$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$new$0$com-android-helper-CleanUp(options);
            }
        }, "cleanup");
        this.thread = thread;
        thread.start();
    ...
    public void lambda$new$0$com-android-helper-CleanUp(Options options) {
        boolean z;
        int i;
        int i2;
        int i3;

...
public class NewDisplayCapture extends SurfaceCapture {
    ...
    public void startNew(Surface surface) {
        ...
        try {
            ...
            this.displaySizeMonitor.start(displayId, new DisplaySizeMonitor.Listener() { // from class: com.android.helper.video.NewDisplayCapture$$ExternalSyntheticLambda0

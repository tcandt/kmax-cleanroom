...
public class ScreenCapture extends SurfaceCapture {
    ...
    public void init() {
        this.displaySizeMonitor.start(this.displayId, new DisplaySizeMonitor.Listener() { // from class: com.android.helper.video.ScreenCapture$$ExternalSyntheticLambda0
            @Override // com.android.helper.video.DisplaySizeMonitor.Listener

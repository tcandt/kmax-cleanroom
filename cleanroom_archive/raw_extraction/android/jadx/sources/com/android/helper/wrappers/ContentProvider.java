    ...
    private Method getCallMethod() throws NoSuchMethodException {
        if (this.callMethod == null) {
            if (Build.VERSION.SDK_INT >= 31) {
                this.callMethod = this.provider.getClass().getMethod("call", FakeContext$$ExternalSyntheticApiModelOutline0.m(), String.class, String.class, String.class, Bundle.class);

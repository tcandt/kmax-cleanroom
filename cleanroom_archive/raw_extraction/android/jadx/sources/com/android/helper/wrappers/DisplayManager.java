...
public final class DisplayManager {
    ...
    public DisplayListenerHandle registerDisplayListener(final DisplayListener displayListener, Handler handler) {
        try {
            ...
            Object objNewProxyInstance = Proxy.newProxyInstance(ClassLoader.getSystemClassLoader(), new Class[]{cls}, new InvocationHandler() { // from class: com.android.helper.wrappers.DisplayManager$$ExternalSyntheticLambda0
                @Override // java.lang.reflect.InvocationHandler
                public final Object invoke(Object obj, Method method, Object[] objArr) {
                    return DisplayManager.lambda$registerDisplayListener$0(displayListener, obj, method, objArr);
                }
            });
            try {
                try {
    ...
    static /* synthetic */ Object lambda$registerDisplayListener$0(DisplayListener displayListener, Object obj, Method method, Object[] objArr) throws Throwable {
        if ("onDisplayChanged".equals(method.getName())) {
            displayListener.onDisplayChanged(((Integer) objArr[0]).intValue());
        }
